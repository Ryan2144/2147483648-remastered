...
function normalWinBase3(merged) {
  return merged === 1610612736;
}
...
function bigInteger() {
  changeRule(function() { return 4194304; }, normalMerge, function(merged) { return merged === 2147483648; });
}
...
function baseThree() {
  changeRule(function() { return Math.random() < 0.9 ? 3 : 6; }, normalMerge, normalWinBase3);
}
